package com.rohitsoni.flutter_sensors
...
class FlutterSensorsPlugin() : FlutterPlugin, MethodCallHandler {
    ...
    companion object {
        private const val CHANNEL_NAME = "flutter_sensors_plus"
    ...
    private fun startEventChannel(arguments: Any, result: MethodChannel.Result) {
        try {
            ...
            if (!eventChannels.containsKey(sensorId)) {
                val eventChannel = EventChannel(messenger, "flutter_sensors_plus/$sensorId")
                val sensorManager =
